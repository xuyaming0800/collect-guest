...
<body>
	...
	<div class="floatright"><span class="lefttext"  >区域：<input id="area" value="" style="line-height: initial;"></span> <a class="btnsizi" href="javacript:void(0);" onclick="query();">查找</a></div><h2 class="title14">区域统计表</h2>
    <div class="clear"></div> 
					...
					<div class="modal-dialog" style="width: 60%;">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">区域任务明细<span style="color: red;">[共<font id="totalCount"></font>条]</span></h4>
							</div>
...
function query(){
	$.post("<%=request.getContextPath()%>/myitems/report/queryAreaStaList.html",{
		pageNo:pageNo,
		pageSize:pageSize,
		...
		if (data.success) {
			...
			if(data.info.objectList != null && data.info.objectList.length > 0) {
				$.each(data.info.objectList,function(i,n){
	    			...
	    			+ "<td>" + n.auditFall + "</td>"
	    			+ "<td><a href='javascript:void(0);' onclick='setArea(\""+n.area+"\",1);return false;'>查看</a></td>"
	    			+ "</tr>";
